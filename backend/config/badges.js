const BADGES = {
  ...
  PYQ_ANALYST: {
    id: 'pyq_analyst',
    name: 'PYQ Analyst',
    description: 'Analyze 5 PYQ PDFs or study notes',
    icon: 'Trophy',
    category: 'achievement',
    criteriaType: 'notes_created',
    criteriaThreshold: 5,
  ...
  STUDY_MARATHON: {
    id: 'study_marathon',
    name: 'Study Marathon',
    description: 'Accumulate 300+ minutes of study focus time',
    icon: 'Clock',
    category: 'study',
    criteriaType: 'focus_minutes',
  ...
  PERFECT_SCORE: {
    id: 'perfect_score',
    name: 'Perfect Score',
    description: 'Achieve 100% on multiple quizzes',
    icon: 'Star',
    category: 'quiz',
    criteriaType: 'perfect_quizzes',
    criteriaThreshold: 3,
    svgIcon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>`
  }
};
