...
const Register = () => {
    ...
    return (
      <div className="min-h-screen flex flex-col justify-between bg-[#FFFBE9] dark:bg-[#000000] text-[#1F150C] dark:text-[#E1DCC9] p-4 sm:p-6 transition-colors duration-300 font-inter relative overflow-hidden">
        ...
        <motion.div
          ...
          className="w-full max-w-md mx-auto my-auto bg-[#E3CAA5]/70 dark:bg-[#1F150C]/90 backdrop-blur-xl rounded-3xl border border-[#CEAB93] dark:border-[#412D15] shadow-2xl p-6 sm:p-8 text-center transition-colors duration-300"
        >
          ...
          <div className="bg-[#E3CAA5]/40 dark:bg-[#2C1E16] border border-[#CEAB93] dark:border-[#412D15] rounded-2xl p-4 mb-6 text-left text-sm text-[#1F150C] dark:text-[#E1DCC9]">
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-[#FFFBE9] dark:bg-[#000000] text-[#1F150C] dark:text-[#E1DCC9] p-4 sm:p-6 transition-colors duration-300 font-inter relative overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-[#AD8B73]/15 dark:bg-[#412D15]/30 rounded-full blur-3xl -z-10 animate-pulse-glow" />
      <div className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-[#CEAB93]/15 dark:bg-[#1F150C]/60 rounded-full blur-3xl -z-10 animate-pulse-glow" style={{ animationDelay: '2s' }} />

      {/* Top Header */}
      <div className="w-full max-w-6xl mx-auto flex items-center justify-between py-2">
        <Link to="/" className="flex items-center gap-2.5 group">
          <div className="bg-[#AD8B73] dark:bg-[#1F150C] p-2 rounded-xl border border-[#CEAB93]/40 dark:border-[#412D15] flex items-center justify-center group-hover:scale-105 transition-transform">
            <BookOpen className="h-5 w-5 text-[#FFFBE9] dark:text-[#E1DCC9]" />
          </div>
          <span className="font-playfair text-lg font-bold text-[#1F150C] dark:text-[#E1DCC9]">
            OpenPrep AI
      ...
      <motion.div
        ...
        animate={{ opacity: 1, y: 0, scale: 1 }}
        transition={{ type: 'spring', stiffness: 90, damping: 15 }}
        className="w-full max-w-md mx-auto my-auto bg-[#E3CAA5]/70 dark:bg-[#1F150C]/90 backdrop-blur-xl rounded-3xl border border-[#CEAB93] dark:border-[#412D15] shadow-2xl p-6 sm:p-8 transition-colors duration-300"
      >
        <div className="text-center mb-8">
          <motion.div
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#AD8B73]/15 text-[#1F150C] dark:bg-[#412D15] dark:text-[#E1DCC9] border border-[#CEAB93]/60 dark:border-[#412D15] text-xs font-semibold mb-4 shadow-sm"
          >
            <Sparkles className="w-3.5 h-3.5 text-[#AD8B73] dark:text-[#E1DCC9]" /> AI-Powered Exam Preparation
          </motion.div>
          <h1 className="text-3xl font-extrabold font-playfair text-[#1F150C] dark:text-[#E1DCC9]">Create Account</h1>
          <p className="text-[#412D15] dark:text-[#C4BA9D] mt-2 text-sm font-medium">Join OpenPrep AI and start your preparation today</p>
        </div>
        ...
        {error && (
          <motion.div
            ...
            className="bg-red-500/10 border border-red-500/30 rounded-2xl p-3.5 mb-6 flex items-start gap-2.5 text-sm text-red-700 dark:text-red-300 font-medium"
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}>
            <label htmlFor="register-email" className="block text-xs font-bold uppercase tracking-wider text-[#1F150C] dark:text-[#E1DCC9] mb-1.5">Email Address</label>
            <div className="relative">
          ...
          <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.25 }}>
            ...
            {formData.password.length > 0 && (
              <motion.ul
                ...
                className="mt-2 space-y-1 bg-[#FFFBE9]/80 dark:bg-[#2C1E16]/80 p-3 rounded-2xl border border-[#CEAB93]/50 dark:border-[#412D15]"
              >
                {PASSWORD_CRITERIA.map((rule, idx) => {
                  const passed = rule.test(formData.password);
                  return (
                    <li key={idx} className={`flex items-center gap-2 text-xs font-semibold ${passed ? 'text-emerald-700 dark:text-emerald-400' : 'text-[#8C6A53] dark:text-[#C4BA9D]'}`}>
                      {passed ? (
          ...
          <motion.button
            ...
            className="w-full py-4 rounded-xl btn-primary-theme font-bold shadow-lg hover:shadow-2xl transition-all duration-200 cursor-pointer flex items-center justify-center gap-2 text-base group"
          >
            {loading ? (
        ...
        <div className="mt-6">
          <motion.a
            ...
            className="w-full py-3.5 rounded-xl btn-secondary-theme font-bold shadow-sm hover:shadow transition-all duration-200 flex items-center justify-center gap-2.5 text-sm cursor-pointer"
          >
