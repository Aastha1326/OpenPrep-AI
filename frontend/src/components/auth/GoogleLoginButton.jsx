...
const GoogleLoginButton = () => {
  ...
  return (
    <button
      ...
      className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-700/50 text-neutral-700 dark:text-neutral-200 font-semibold rounded-xl shadow-sm transition-all text-sm"
    >
