/**
 * @fileoverview Messaging-app-style chat interface with markdown support and typing indicators.
 */
...
const ChatInterface = ({ messages, onSendMessage, isTyping }) => {
    ...
    return (
        <div className="flex flex-col h-[600px] bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50 dark:bg-gray-900">
                {messages.length === 0 && (
                    <div className="text-center text-gray-500 dark:text-gray-400 mt-10">
                        <p className="text-lg font-medium">Hello! I'm your AI Study Companion.</p>
                        <p className="text-sm">Ask me anything about your current topic, and I'll guide you through it.</p>
                    </div>
                )}
                ...
                {messages.map((msg, index) => (
                    ...
                    >
                        ...
                        >
                            {/* Simple whitespace preservation for mock markdown */}
            ...
            {/* Input Area */}
            <form onSubmit={handleSubmit} className="p-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 flex gap-2">
                <input
                    type="text"
                    value={input}
